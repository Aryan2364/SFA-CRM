...
const SECTIONS = [
  ...
  },
  {
    ...
    links: [
      {
        // Users had the sidebar as its only route in until the shell's
        // navigation collapsed to nine entries (AGENTS.md 12.1). It is a
        // child of Masters and is reached from here.
