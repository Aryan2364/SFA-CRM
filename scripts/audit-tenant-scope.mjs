...
const BATCH_FILES = {
  ...
  'ops-and-settings': [
    'src/app/api/points/config/route.ts',
    'src/app/api/points/config/history/route.ts',
    'src/app/api/points/leaderboard/route.ts',
    'src/app/api/points/my/route.ts',
    'src/app/api/points/settings/route.ts',
    'src/app/api/review/daily-activity/route.ts',
    'src/app/api/review/expenses/route.ts',
    'src/app/api/review/summary-cards/route.ts',
    'src/app/api/dashboard/manager/route.ts',
    'src/app/api/dashboard/stats/route.ts',
    'src/app/api/remarks/route.ts',
    'src/app/api/remarks/[id]/read/route.ts',
    'src/app/api/conversations/route.ts',
    'src/app/api/notifications/route.ts',
    'src/app/api/notifications/read-all/route.ts',
    'src/app/api/notifications/[id]/route.ts',
    'src/app/api/access-control/org-chart/route.ts',
    'src/app/api/access-control/visibility/route.ts',
    'src/app/api/access-control/visibility/all/route.ts',
    'src/app/api/access-control/visibility/bulk-import/route.ts',
